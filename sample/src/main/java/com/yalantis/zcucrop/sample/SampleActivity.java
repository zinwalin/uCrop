package com.yalantis.zcucrop.sample;
...
import com.yalantis.zcucrop.UCropActivity;
import com.yalantis.zcucrop.UCropFragment;
import com.yalantis.zcucrop.UCropFragmentCallback;
...
public class SampleActivity extends BaseActivity implements UCropFragmentCallback {
    ...
    /**
     * Sometimes you want to adjust more options, it's done via {@link com.yalantis.zcucrop.UCrop.Options} class.
     *
     * @param uCrop - ucrop builder instance
     * @return - ucrop builder instance
     */
